  ...
  <div class="flex h-screen overflow-hidden bg-gray-50">
    ...
    >
      <div class="flex h-16 items-center gap-3 border-b border-slate-700/50 px-6">
        <div
          class="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-primary-500 to-primary-600 text-sm font-bold text-white shadow-lg shadow-primary-500/25"
        >
          A
        </div>
        <div>
          <h1 class="text-base font-semibold tracking-tight text-white">Admin Panel</h1>
      ...
      <nav class="flex-1 space-y-1 overflow-y-auto px-3 py-4">
        ...
        <router-link
          ...
          :class="
            isActive(item.to)
              ? 'bg-gradient-to-r from-primary-500/15 to-primary-500/10 text-primary-400 shadow-sm'
      ...
      <div class="border-t border-slate-700/50 p-4">
        <div class="flex items-center gap-3 rounded-lg bg-slate-800/50 p-3">
          <div
            class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-primary-400 to-primary-500 text-sm font-bold text-white shadow-lg"
          >
            {{ userInitials }}
          </div>
      ...
      >
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="relative">
            ...
            >
              <div
                class="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-primary-400 to-primary-500 text-xs font-bold text-white shadow-sm"
              >
                {{ userInitials }}
              </div>
              <div class="hidden text-left md:block">
                ...
                <p class="text-xs leading-tight text-gray-400">Admin</p>
              </div>
              <svg
