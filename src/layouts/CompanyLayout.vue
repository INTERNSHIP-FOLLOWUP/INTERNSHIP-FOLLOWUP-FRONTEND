...
const navItems = computed((): NavItem[] => [
  ...
  {
    name: 'students',
    label: 'nav.company.assignedStudents',
    to: '/company/students',
    icon: createIcon(
  ...
  {
    name: 'internships',
    label: 'nav.company.internshipInfo',
