...
api.interceptors.request.use(
  (config: InternalAxiosRequestConfig) => {
    ...
    if (config.method?.toLowerCase() === 'get') {
      ...
      ;(config as InternalAxiosRequestConfig & { cancelToken?: unknown; cancel?: () => void }).cancelToken = new axios.CancelToken((cancel) => {
        ;(config as InternalAxiosRequestConfig & { cancelToken?: unknown; cancel?: () => void }).cancel = () => {
