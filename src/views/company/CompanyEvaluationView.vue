<template>
  <div class="space-y-6 max-w-4xl mx-auto pb-16 animate-fade-in font-sans">
    ...
    <div class="rounded-3xl border dark:border-slate-600 border-slate-200 dark:bg-slate-800 bg-white shadow-sm overflow-hidden transition-all">
      ...
      <div class="p-6 sm:p-8 space-y-3">
        ...
        <h1 class="text-2xl sm:text-3xl font-extrabold dark:text-slate-100 text-slate-900 tracking-tight">
    ...
    <form class="space-y-6" @submit.prevent="submit">
      ...
      <div class="rounded-3xl border dark:border-slate-600 border-slate-200/80 dark:bg-slate-800 bg-white p-6 sm:p-8 shadow-sm space-y-4 hover:border-slate-300 transition-all">
        <div>
          <label class="block text-base font-bold dark:text-slate-100 text-slate-900 mb-1">
            Choose Assigned Intern Student <span class="text-red-500">*</span>
          </label>
          <p class="text-xs dark:dark:text-slate-500 text-slate-400 text-slate-500 mb-3">Select the PNC student assigned to your company for evaluation.</p>

          <select
            v-model="form.student_id"
            class="w-full rounded-2xl border dark:border-slate-600 border-slate-200 bg-[#EDF4FE]/60 px-4 py-3.5 text-sm dark:text-slate-100 text-slate-900 font-semibold focus:border-[#21BAEA] focus:dark:bg-slate-800 bg-white focus:outline-none focus:ring-2 focus:ring-[#21BAEA]/20 transition-all cursor-pointer"
        ...
        <div v-if="selectedStudent" class="rounded-2xl border border-blue-100 bg-[#F4F9FF] p-4.5 space-y-3 transition-all animate-fade-in">
          <div class="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-blue-100">
            <div class="flex items-center gap-3">
              ...
              <div>
                <h4 class="text-sm font-bold dark:text-slate-100 text-slate-900">{{ selectedStudent.name || selectedStudent.student_name }}</h4>
                <p class="text-xs dark:dark:text-slate-500 text-slate-400 text-slate-500">{{ selectedStudent.email || selectedStudent.student_email || 'pnc.student@passerellesnumeriques.org' }}</p>
              </div>
            </div>
          ...
          <div class="flex items-center gap-3 dark:bg-slate-800 bg-white p-3.5 rounded-xl border border-blue-100 shadow-2xs">
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[11px] dark:dark:text-slate-500 text-slate-400 text-slate-500 truncate">
      ...
      <div class="rounded-3xl border dark:border-slate-600 border-slate-200/80 dark:bg-slate-800 bg-white p-6 sm:p-8 shadow-sm space-y-4 hover:border-slate-300 transition-all">
        <div class="flex items-start justify-between gap-3">
          <div>
            <h3 class="text-base font-bold dark:text-slate-100 text-slate-900">
              1. Technical Competence & Problem Solving <span class="text-red-500">*</span>
            </h3>
            <p class="text-xs dark:dark:text-slate-500 text-slate-400 text-slate-500 mt-1 leading-relaxed">
        ...
        <div class="space-y-2.5 pt-2">
          <label
            ...
            :class="form.technical_skill === opt.score ? 'border-[#21BAEA] bg-[#21BAEA]/5 shadow-2xs' : 'dark:border-slate-600 border-slate-200/80 dark:bg-slate-700 bg-slate-50/40 hover:dark:bg-slate-700 bg-slate-50'"
          >
            <div class="flex items-center gap-3">
              <input
              ...
              />
              <div>
                <p class="text-sm font-bold dark:text-slate-100 text-slate-900">{{ opt.label }}</p>
                <p class="text-xs dark:dark:text-slate-500 text-slate-400 text-slate-500">{{ opt.desc }}</p>
              </div>
            </div>
            <span class="text-xs font-extrabold px-2.5 py-1 rounded-lg" :class="form.technical_skill === opt.score ? 'bg-[#21BAEA] text-white' : 'dark:bg-slate-600 bg-slate-100 dark:text-slate-400 text-slate-600'">
              {{ opt.score }} pts
            </span>
          </label>
        </div>
      ...
      <div class="rounded-3xl border dark:border-slate-600 border-slate-200/80 dark:bg-slate-800 bg-white p-6 sm:p-8 shadow-sm space-y-4 hover:border-slate-300 transition-all">
        ...
        <div class="space-y-2.5 pt-2">
          <label
            ...
            :key="opt.score"
            class="flex items-center justify-between p-3.5 rounded-2xl border transition-all cursor-pointer select-none"
            :class="form.communication === opt.score ? 'border-[#FF9933] bg-[#FF9933]/5 shadow-2xs' : 'dark:border-slate-600 border-slate-200/80 dark:bg-slate-700 bg-slate-50/40 hover:dark:bg-slate-700 bg-slate-50'"
          >
            <div class="flex items-center gap-3">
              <input
            ...
            <span class="text-xs font-extrabold px-2.5 py-1 rounded-lg" :class="form.communication === opt.score ? 'bg-[#FF9933] text-white' : 'dark:bg-slate-600 bg-slate-100 dark:text-slate-400 text-slate-600'">
              {{ opt.score }} pts
            </span>
          </label>
        </div>
      ...
      <div class="rounded-3xl border dark:border-slate-600 border-slate-200/80 dark:bg-slate-800 bg-white p-6 sm:p-8 shadow-sm space-y-4 hover:border-slate-300 transition-all">
        ...
        <div class="space-y-2.5 pt-2">
          <label
            ...
            :key="opt.score"
            class="flex items-center justify-between p-3.5 rounded-2xl border transition-all cursor-pointer select-none"
            :class="form.professionalism === opt.score ? 'border-emerald-500 bg-emerald-50/40 shadow-2xs' : 'dark:border-slate-600 border-slate-200/80 dark:bg-slate-700 bg-slate-50/40 hover:dark:bg-slate-700 bg-slate-50'"
          >
            <div class="flex items-center gap-3">
              <input
            ...
            <span class="text-xs font-extrabold px-2.5 py-1 rounded-lg" :class="form.professionalism === opt.score ? 'bg-emerald-600 text-white' : 'dark:bg-slate-600 bg-slate-100 dark:text-slate-400 text-slate-600'">
              {{ opt.score }} pts
            </span>
          </label>
        </div>
      ...
      <div class="rounded-3xl border dark:border-slate-600 border-slate-200/80 dark:bg-slate-800 bg-white p-6 sm:p-8 shadow-sm space-y-4 hover:border-slate-300 transition-all">
        ...
        <div class="space-y-2.5 pt-2">
          <label
            ...
            :key="opt.score"
            class="flex items-center justify-between p-3.5 rounded-2xl border transition-all cursor-pointer select-none"
            :class="form.attendance === opt.score ? 'border-purple-500 bg-purple-50/40 shadow-2xs' : 'dark:border-slate-600 border-slate-200/80 dark:bg-slate-700 bg-slate-50/40 hover:dark:bg-slate-700 bg-slate-50'"
          >
            <div class="flex items-center gap-3">
              <input
            ...
            <span class="text-xs font-extrabold px-2.5 py-1 rounded-lg" :class="form.attendance === opt.score ? 'bg-purple-600 text-white' : 'dark:bg-slate-600 bg-slate-100 dark:text-slate-400 text-slate-600'">
              {{ opt.score }} pts
            </span>
          </label>
        </div>
      ...
      <div class="rounded-3xl border dark:border-slate-600 border-slate-200/80 dark:bg-slate-800 bg-white p-6 sm:p-8 shadow-sm space-y-4 hover:border-slate-300 transition-all">
        <div>
          ...
          <p class="text-xs dark:dark:text-slate-500 text-slate-400 text-slate-500 mt-1">Select the key positive traits observed during the internship placement.</p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
          <label
            ...
            :class="selectedStrengths.includes(strength) ? 'border-[#21BAEA] bg-[#21BAEA]/10 font-bold text-[#21BAEA]' : 'dark:border-slate-600 border-slate-200/80 dark:bg-slate-700 bg-slate-50/40 dark:text-slate-200 text-slate-700 hover:dark:bg-slate-700 bg-slate-50'"
          >
            <input
              type="checkbox"
              :value="strength"
      ...
      <div class="rounded-3xl border dark:border-slate-600 border-slate-200/80 dark:bg-slate-800 bg-white p-6 sm:p-8 shadow-sm space-y-4 hover:border-slate-300 transition-all">
        <div>
          ...
          <p class="text-xs dark:dark:text-slate-500 text-slate-400 text-slate-500 mt-1">Select areas where the student should continue to develop and improve.</p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
          <label
            ...
            :key="area"
            class="flex items-center gap-3 p-3 rounded-2xl border transition-all cursor-pointer select-none"
            :class="selectedGrowthAreas.includes(area) ? 'border-[#FF9933] bg-[#FF9933]/10 font-bold text-[#FF9933]' : 'dark:border-slate-600 border-slate-200/80 dark:bg-slate-700 bg-slate-50/40 dark:text-slate-200 text-slate-700 hover:dark:bg-slate-700 bg-slate-50'"
          >
            <input
              type="checkbox"
              :value="area"
      ...
      <div class="rounded-3xl border dark:border-slate-600 border-slate-200/80 dark:bg-slate-800 bg-white p-6 sm:p-8 shadow-sm space-y-5 hover:border-slate-300 transition-all">
        <div>
          <h3 class="text-base font-bold dark:text-slate-100 text-slate-900">
            7. Overall Feedback & Future Recommendation
          </h3>
          <p class="text-xs dark:dark:text-slate-500 text-slate-400 text-slate-500 mt-1">Share additional qualitative feedback or career recommendations for the student.</p>
        </div>

        <div class="space-y-3">
          <label class="block text-xs font-bold dark:text-slate-200 text-slate-700">Future Employment Recommendation</label>
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
            <label
              ...
              :class="recommendation === rec ? 'border-[#21BAEA] bg-[#21BAEA]/10 font-bold dark:text-slate-100 text-slate-900' : 'dark:border-slate-600 border-slate-200 dark:bg-slate-700 bg-slate-50/50 dark:text-slate-200 text-slate-700 hover:dark:bg-slate-700 bg-slate-50'"
            >
              <input
        ...
        <div class="space-y-2">
          <label class="block text-xs font-bold dark:text-slate-200 text-slate-700">Supervisor Detailed Comments (Paragraph Text)</label>
          <textarea
            v-model="form.feedback"
            rows="4"
            class="w-full rounded-2xl border dark:border-slate-600 border-slate-200 dark:bg-slate-800 bg-white p-4 text-sm dark:text-slate-100 text-slate-900 placeholder-slate-400 focus:border-[#21BAEA] focus:outline-none focus:ring-2 focus:ring-[#21BAEA]/20 transition-all"
            placeholder="Write constructive observations, project highlights, or growth advice..."
          />
        </div>

        <!-- Submit Button -->
        <div class="flex items-center justify-between pt-4 border-t dark:border-slate-700 border-slate-100">
          ...
          <div class="flex items-center gap-3">
            <button
              type="button"
              class="px-5 py-3 rounded-xl border dark:border-slate-600 border-slate-200 dark:text-slate-200 text-slate-700 text-sm font-semibold hover:dark:bg-slate-700 bg-slate-50 transition-colors"
              @click="resetForm"
            >
              Clear Form
            </button>
    ...
    <div class="rounded-3xl border dark:border-slate-600 border-slate-200/80 dark:bg-slate-800 bg-white p-6 sm:p-8 shadow-sm space-y-4 pt-6 mt-10">
      <div class="flex items-center justify-between border-b dark:border-slate-700 border-slate-100 pb-4">
        <div>
          <h3 class="text-lg font-bold dark:text-slate-100 text-slate-900">Submitted Evaluation Records</h3>
          <p class="text-xs dark:dark:text-slate-500 text-slate-400 text-slate-500">Evaluations sent to PNC Tutors & persisted in database</p>
        </div>
      ...
      <div v-if="loadingEvaluations" class="py-8 text-center dark:text-slate-500 text-slate-400 text-xs">
        Loading evaluation records...
      </div>

      <div v-else-if="!submittedEvaluations.length" class="py-8 text-center dark:text-slate-500 text-slate-400 text-xs">
      ...
      <div v-else class="space-y-4">
        <div
          ...
          :key="item.id"
          class="rounded-2xl border dark:border-slate-600 border-slate-200/80 dark:bg-slate-700 bg-slate-50/50 p-5 space-y-3 transition-all hover:dark:bg-slate-800 bg-white hover:shadow-md"
        >
          <div class="flex flex-wrap items-start justify-between gap-3">
            <div>
              <h4 class="text-base font-bold dark:text-slate-100 text-slate-900">{{ getStudentName(item) }}</h4>
              <p class="text-xs dark:dark:text-slate-500 text-slate-400 text-slate-500">Submitted on {{ formatDate(item.created_at) }}</p>
            </div>
          ...
          <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 py-2 dark:bg-slate-800 bg-white rounded-xl border dark:border-slate-700 border-slate-100 text-center text-xs">
            <div class="p-2 border-r dark:border-slate-700 border-slate-100">
              <p class="dark:text-slate-500 text-slate-400 text-[10px]">Technical</p>
              <p class="font-bold text-[#21BAEA]">{{ item.technical_skill }}</p>
            </div>
            <div class="p-2 border-r dark:border-slate-700 border-slate-100">
              <p class="dark:text-slate-500 text-slate-400 text-[10px]">Communication</p>
              <p class="font-bold text-[#FF9933]">{{ item.communication }}</p>
            </div>
            <div class="p-2 border-r dark:border-slate-700 border-slate-100">
              <p class="dark:text-slate-500 text-slate-400 text-[10px]">Ethics</p>
              <p class="font-bold text-emerald-600">{{ item.professionalism }}</p>
            </div>
            <div class="p-2">
              <p class="dark:text-slate-500 text-slate-400 text-[10px]">Attendance</p>
              <p class="font-bold text-purple-600">{{ item.attendance }}</p>
            </div>
          </div>

          <p v-if="item.feedback" class="text-xs dark:text-slate-200 text-slate-700 dark:bg-slate-800 bg-white p-3 rounded-xl border dark:border-slate-700 border-slate-100 leading-relaxed whitespace-pre-line">
            "{{ item.feedback }}"
          </p>
        </div>
      </div>
