<template>
  <div class="p-6 space-y-6">
    ...
    <!-- Data Table -->
    <div
      v-if="!followupStore.loading && followupStore.followups.length"
          ...
          <div class="flex items-start justify-between gap-2">
            <div class="min-w-0">
              ...
              <div class="mt-1">
                <span
                  ...
                  :class="statusBadge(f.status)"
                >
                  <span class="h-1.5 w-1.5 rounded-full" :class="statusDot(f.status)"></span>
                  {{ f.status }}
                </span>
              </div>
            </div>
            <div class="flex items-center gap-1">
              <button
                ...
                class="inline-flex items-center gap-1 rounded-lg border border-slate-200 bg-white px-2 py-1 text-xs font-semibold text-slate-700 shadow-sm active:scale-95"
              >
              ...
              <button
                ...
                class="inline-flex items-center gap-1 rounded-lg bg-red-600 px-2 py-1 text-xs font-semibold text-white shadow-sm active:scale-95"
              >
                <svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    stroke-linecap="round"
          ...
          <table class="min-w-full border-collapse text-left text-sm">
            ...
            <tbody class="divide-y divide-slate-50">
              ...
              >
                ...
                <td
                  class="hidden whitespace-nowrap px-4 py-3 text-slate-600 md:table-cell md:px-5 md:py-4"
                >
                  {{ f.next_followup ? formatDate(f.next_followup) : '—' }}
                </td>
    ...
    <!-- Empty state -->
    <div
      v-else-if="!followupStore.loading"
      class="flex flex-col items-center justify-center rounded-2xl border border-slate-100 bg-white py-14 text-center"
    >
    ...
    <transition name="modal-scale">
      ...
      >
        <div
          class="w-full max-w-xl max-h-[85vh] overflow-y-auto rounded-2xl border border-slate-100 bg-white shadow-2xl"
        >
          <!-- Header with gradient -->
          <div
            class="sticky top-0 z-10 flex items-center justify-between bg-gradient-to-r from-indigo-600 to-indigo-500 px-6 py-4 rounded-t-2xl"
          >
            <div class="flex items-center gap-3">
              <div
                class="flex h-9 w-9 items-center justify-center rounded-lg bg-white/20 backdrop-blur-sm"
              >
                <svg
          ...
          <div class="p-6 space-y-5">
            ...
            <div class="grid grid-cols-2 gap-5">
              ...
              >
                <div
                  class="flex items-center gap-2 text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2"
                >
                  <svg
            ...
            <div class="grid grid-cols-2 gap-5">
              ...
              >
                ...
                >
                  <span
                    ...
                    :class="meetingTypeDot(viewingFollowup.meeting_type)"
                  ></span>
              ...
              >
                ...
                <span
                  class="inline-flex items-center gap-1.5 rounded-full px-3 py-1 text-xs font-semibold"
                  :class="statusBadge(viewingFollowup.status)"
                >
                  <span
                    class="h-1.5 w-1.5 rounded-full"
                    :class="statusDot(viewingFollowup.status)"
                  ></span>
            ...
            <div class="grid grid-cols-2 gap-5">
              ...
              >
                ...
                <p
                  class="text-sm font-medium"
                  :class="viewingFollowup.next_followup ? 'text-slate-800' : 'text-slate-400'"
                >
                  {{
            ...
            <!-- Action Items card -->
            <div
              v-if="viewingFollowup.action_items"
              class="rounded-xl border border-amber-100 bg-amber-50/50 p-4"
            >
              <div
                class="flex items-center gap-2 text-xs font-semibold text-amber-600 uppercase tracking-wider mb-2"
              >
                <svg
