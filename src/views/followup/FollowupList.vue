...
<template>
  <div class="p-6 space-y-6">
    ...
    <div class="flex items-center gap-3">
      <input
        v-model="search"
        class="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm text-slate-700 outline-none transition-colors focus:border-indigo-300 focus:ring-2 focus:ring-indigo-500/20"
